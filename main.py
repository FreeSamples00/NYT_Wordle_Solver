                ...
                for i, l in enumerate(word):
                    if l == letter:
                        ...
                        abcs[abc.index(letter)][4] = int(
                            round(
                                abcs[abc.index(letter)][2] / abcs[abc.index(letter)][3],
                                0,
                            )
                        )
...
def display_letter(row, place, letter):
    if letter == "delete":
        ...
        pens[row - 1][place - 1].write(
            letter.upper(), font=("impact", 30, "bold"), align="center"
        )
...
answerlist = f"{wordlist_dir}/NYTpossibleanswers.txt"
wordlist = f"{wordlist_dir}/NYTwords.txt"
